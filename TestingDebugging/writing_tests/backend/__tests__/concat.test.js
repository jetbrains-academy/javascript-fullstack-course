...
describe('Concat tests', () => {
    ...
    describe('GET /concat', () => {
        it('should return the concatenation of two strings', async () => {
            return request(httpServer).get('/concat?str1=Hello&str2=World').then(response => {
        ...
        it('should concatenate numbers as strings', async () => {
            return request(httpServer).get('/concat?str1=123&str2=456').then(response => {
                expect(response.status).toBe(200);
        ...
        it('should return an error if "str1" or "str2" is missing', async () => {
            return request(httpServer).get('/concat?str1=Hello').then(response => {
