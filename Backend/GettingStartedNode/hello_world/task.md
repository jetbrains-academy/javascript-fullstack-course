...
First, we create an HTTP server using the `createServer` method and specify a [callback](https://developer.mozilla.org/en-US/docs/Glossary/Callback_function) handler function for all incoming requests.
